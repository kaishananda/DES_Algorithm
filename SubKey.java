...
public class SubKey{
    ...
    int[][] s2 = {{15, 1, 8, 14, 6, 11, 3, 5, 9, 7, 2, 13, 12, 0, 5, 10},
    ...
    void SubKeyFind(String key){
        ...
        char[] tempTrueKey = binnaryValueKey.toCharArray();
        ...
        for(int i=1; i<=16; i++){
           ...
           subKey[i-1] = String.valueOf(binnaryKeyPC2);
           System.out.println("K" + i + " : " + (subKey[i-1]));
        }   
    }
    /*
    ...
    */
    String[] GroupingTeks(String binText)throws Exception{
