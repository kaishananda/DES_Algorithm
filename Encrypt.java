 ...
 */
public class Encrypt extends SubKey {
    ...
    void EncryptMessage(String message, String key)throws Exception{            //masukkan plain dan key ke method
        ...
        Decrypt callDecrypt = new Decrypt();
        System.out.println("\n\nDecrypt");
        System.out.println("Chipper = " + decryptedMessage);
        System.out.println("Key = " + key);
        callDecrypt.SubKeyFind(key);
        callDecrypt.DecryptMessage(decryptedMessage);
    }
